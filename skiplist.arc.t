...
(insert-sl sl "aaaa")
(delete-worst-sl sl)
(test-ok "delete-worst works" (~find-sl sl "aaaa"))
(delete-worst-sl sl)
(delete-worst-sl sl)
(delete-worst-sl sl)
(test-ok "delete-worst keeps deleting down to 0" (is 0 slen.sl))
(delete-worst-sl sl)
(test-ok "delete-worst can handle empty skiplist" (is 0 slen.sl))
(= sl (slist len))
(insert-sl sl "a")
(insert-sl sl "aaa")
(insert-sl sl "aa")
(insert-sl sl "aaaa")
(clamp-sl sl 2)
(test-ok "clamp-sl works" (is 2 slen.sl))
